document.addEventListener("DOMContentLoaded",()=>{
  ...
  const T={
    ...
    tr:{
      ...
      build:[["Oyunlar","Sıfırdan geliştirilen interaktif dünyalar, oyun sistemleri ve deneyimler."],["Uygulamalar","Gerçek problemler ve gerçek insanlar etrafında tasarlanan faydalı dijital ürünler."],["Dijital Ürünler","Fikirlerin yaşayacağı web siteleri, platformlar ve dijital deneyimler."]],
      selected:"SEÇİLİ ÇALIŞMALAR",projectsTitle:"Ürünler, fikirler ve <em>denemeler.</em>",projectsDescription:"Burion Studio bünyesinde şu anda şekillendirdiğim ürün ve fikirlerden bir seçki.",
    ...
    ru:{
      ...
      eyebrow:"BURION STUDIO",heroTitle:"Идеи,<br>превращённые в <em>реальность.</em>",heroDescription:"Независимый разработчик, создающий игры, приложения и цифровые продукты от идеи до релиза.",explore:"Исследовать студию",getInTouch:"Связаться",what:"ЧТО Я СОЗДАЮ",buildTitle:"Превращаю идеи в <em>цифровые продукты.</em>",
      build:[["Игры","Интерактивные миры, игровые системы и впечатления, созданные с нуля."],["Приложения","Полезные цифровые продукты, созданные вокруг реальных задач и людей."],["Цифровые продукты","Сайты, платформы и цифровые решения, где идеи получают своё место."]],
      selected:"ИЗБРАННЫЕ РАБОТЫ",projectsTitle:"Продукты, концепции и <em>эксперименты.</em>",projectsDescription:"Подборка продуктов и идей, которые сейчас развиваются в Burion Studio.",
